...
from tests.conftest import card_number, account_number, date_src


def test_mask_account_card_visa(card_number):
...
def test_mask_account_card_mastercard(card_number):
...
def test_mask_account_card_account(account_number):
...
def test_get_date_errors(invalid_date):
